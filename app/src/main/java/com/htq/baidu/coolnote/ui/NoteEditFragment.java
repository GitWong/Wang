    ...
    public void click( FloatingActionButton menuItem)
    {
        ...
        switch(menuItem.getId())
        {
            case R.id.menu_item_share:{
                ...
                {
                    Toast.makeText(getActivity(),"ni还未输入内容",Toast.LENGTH_LONG).show();
                }else {
            ...
            case R.id.menu_item_clock:{
                ...
                {
                    Toast.makeText(getActivity(),"Lee,内容为空哦",Toast.LENGTH_LONG).show();
                }
            ...
            case R.id.menu_item_desktop:{
                ...
                {
                    Toast.makeText(getActivity(),"Ming, 内容为空，添加失败",Toast.LENGTH_LONG).show();
                }
            } break;
        }
    ...
    private void addToDesktop(String title) {
       ...
       // SPUtils.put(getActivity(),DESKTOP,title);//将内容保存至share中
        ...
        intent.putExtra(Intent.EXTRA_SHORTCUT_ICON_RESOURCE,
                Intent.ShortcutIconResource.fromContext(getActivity(), R.drawable.logo));
